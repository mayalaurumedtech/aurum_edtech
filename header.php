  ...
  <header class="ree-header fixed-top">
    <div class="container-fluid m-p-l-r-0">
      <div class="menu-header horzontl">
        <div class="menu-logo">
          <div class="dskt-logo"><a class="nav-brand" href="aurumedtech.php"> <img src="images/aurum-logo.png" alt="Logo" class="ree-logo" /> </a> </div>
        </div>
        <div class="ree-nav" role="navigation">
          <ul class="nav-list">
            <li>
              <a href="aurumedtech.php" class="menu-links">Home</a>
            </li>
            <li>
              <a href="about-us.php" class="menu-links">About Us</a>
            </li>
            <li>
              <a href="service.php" class="menu-links">Service</a>
            </li>
            <li>
              <a href="team.php" class="menu-links">Team</a>
            </li>
            <li>
